...
export default function RecipeCardSummary({title, img = imgStub, description, showRecipe}: RecipeCardSummaryProps) {

    return(

        <RecipeCard action={showRecipe} className={`${classNames.wrapper}`}>

            <img src={toRelative(img) || imgStub} alt="product image" width={100} height={100} className={classNames.img}/>
